  ...
  return (
    <div className={styles.wrapper}>
      <div className="container">
        <h1 className={styles.title}>What you’ll Learn In this</h1>
        <p className={styles.subTitle}>
          4 Hours Live <span>Workshop</span>
        </p>
        <div className={styles.list}>
          <div>
            <ul>
              ...
              <li>
                Learn about the world&rsquo;s top Data Analytics tool by
                Microsoft POWER BI
              </li>
              <li>
                Learn about industry needs and expectations from 21st-century
                data analyst
              </li>
          ...
          <div>
            <ul>
              ...
              <li>
                How to make a strong portfolio and How to start freelancing
              </li>
